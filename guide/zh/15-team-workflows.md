...
引入 AI 后，团队需要用数据回答："AI 到底有没有让我们更快/更好？"

### 核心指标

| 指标 | 怎么测 | 健康范围 |
|------|--------|---------|
| **交付速度变化** | 对比引入 AI 前后的 PR 合并周期 | 缩短 20-40% 为健康 |
| **首次 CI 通过率** | AI 生成代码的 CI 一次通过比例 | > 70% |
| **Review 返工率** | AI 代码在 review 中被修改的比例 | < 30% |
| **上线 bug 率** | AI 代码上线后 7 天 bug 数 vs 人工代码 | 应持平或更低 |
| **开发者满意度** | 月度匿名调查（1-5 分） | > 3.5 |

### 避免虚荣指标

不要只看"AI 生成了多少行代码"——代码行数不等于价值。关注的是质量和交付效率，而不是产出数量。

## 规模化推广

从 1 个人用 AI 到 100 人用 AI，不是简单的复制。

### 分阶段推广

| 阶段 | 人数 | 重点 |
|------|------|------|
| 试点 | 1-3 人 | 验证工具效果，踩坑，写 CLAUDE.md |
| 扩展 | 5-15 人 | 标准化配置（CLAUDE.md + Hooks + 权限），建立 Review 规范 |
| 全员 | 全团队 | 培训、度量、持续优化 |

### 避免"AI 僵尸代码"

最大的风险不是 AI 写出 bug——而是团队接受了 AI 的代码但没人理解它。

预防措施：
- **Review 时必须理解**：Reviewer 对 AI 代码的标准应该和人写的一样
- **注释关键决策**：如果 AI 用了不常见的方案，要求开发者补充注释说明为什么选了这个方案
- **知识共享**：定期分享"AI 写了个有意思的方案"或"AI 踩了个坑"的案例
